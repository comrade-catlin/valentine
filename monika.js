...
function jumpMonika() {
    if (jumpCount < 4) {
        ...
        monika0.src = "https://static.wikia.nocookie.net/doki-doki-literature-club/images/7/7e/Monika_Sticker_Excited.png";
        monika0.style.bottom = jumpHeight + 'px';
        
        setTimeout(() => {
            monika0.style.bottom = (basePosition + 20) + 'px';
            monika0.src = "https://static.wikia.nocookie.net/doki-doki-literature-club/images/4/49/Monika_Sticker_Distrait.png";
        }, 300);
